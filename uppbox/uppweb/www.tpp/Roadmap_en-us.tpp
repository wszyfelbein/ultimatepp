...
[s0; [* Core]&]
[s0; &]
[s0;i93;O0; SIMD encapsulation i8x16 comparisons, AnyTrue, AllTrue, 
CountTrue, FirstTrue, FirstFalse, IsTrue functions&]
[s0;i93;O0; Added some additional Color constants (e.g. Orange)&]
[s0;i93;O0; CountTrailingZeroBits, CountTrailingZeroBits64 functions&]
[s0;i93;O0; CPU`_Cores fixed to support more than 64 cores&]
[s0;i93;O0; memcnt`[8,16,32`], memeq8len functions&]
[s0;i93;O0; Point`_, Size`_ and Rect`_ no initialize to zero&]
[s0;i93;O0; IsUserAdmin() function&]
[s0;i93;O0; StringsStream (like StringStream, but using Vector to 
avoid String 2GB limit)&]
[s0;i93;O0; CParser.SkipLine&]
[s0;i93;O0; Unix domain socket (AF`_UNIX) support, TcpSocket replaced 
with just Socket (as it is now both for Tcp and Unix domain)&]
[s0; &]
[s0; [* Core/SSL]&]
[s0; &]
[s0;i93;O0; AES`-256`-GCM encryption and decryption&]
[s0;i93;O0; Added SecureBuffer and SecureZero&]
[s0; &]
[s0; [* CtrlCore]&]
[s0;* &]
[s0;i93;O0; support for custom window titlebars in Win32 and Linux/gtk 
backends&]
[s0;i93;O0; Ctrl.HasMouseIn (unlike HasMouse limited to view)&]
[s0;i93;O0; IsAvailableImage, IsClipboardAvailableImage&]
[s0;i93;O0; Paint hook (allows painting anywhere in window unrelated 
to any widgets)&]
[s0;i93;O0; X11 (nongtk) backend maintenance&]
[s0;i93;O0; X11 now reading StdFont and dark/light mode from xsettings&]
[s0; &]
[s0; [* Draw]&]
[s0;* &]
[s0;i93;O0; Font.NoColor to prevent colored emoticons&]
[s0;i93;O0; Draw9Slice&]
[s0;i93;O0; Fast cached HasCodepoint for TTF&]
[s0;i93;O0; Templated version of MakeImage&]
[s0;i93;O0; DrawRoundRect (without Painter)&]
[s0; &]
[s0; [* Painter]&]
[s0;* &]
[s0;i93;O0; currentColor support in SVG; ide: Improved/simplified 
SVG view&]
[s0;i93;O0; Fixed precision issue with Arc and Stroker&]
[s0; &]
[s0; [* CtrlLib]&]
[s0;* &]
[s0;i93;O0; DrawSmartText, DrawLabel, Label now support vertical 
orientation&]
[s0;i93;O0; DisplayPopup refactored with PaintHook&]
[s0;i93;O0; .upt for Basic CtrlLib app now has MyApp option&]
[s0;i93;O0; FileSelButton now remembers last dir&]
[s0;i93;O0; ArrayCtrl.Column.Inserts(fn) (when new line is inserted, 
Function provides the initial value)&]
[s0;i93;O0; DataPusher ConvertBy (conversion done by Function)&]
[s0;i93;O0; RichTextView.SingleLine option&]
[s0; RichText, RichEdit:&]
[s0;i93;O0; RichText.SingleLine option&]
[s0;i93;O0; Diagram editor&]
[s0;i93;O0; RichEdit Insert special character&]
[s0;i93;O0; RichEdit.OverridePaper&]
[s0; &]
[s0; [* VirtualGui/SDL]&]
[s0;* &]
[s0;i93;O0; Fullscreen mode&]
[s0; &]
[s0; [* TheIDE]&]
[s0;* &]
[s0;i93;O0; Now using BasicHints at the start to help beginners with 
using the program&]
[s0;i93;O0; Activating `"No warnings`" in the main package has now 
the sideeffect of disabling assist to show errors while editing&]
[s0;i93;O0; Improvements in comparison of directories / commits, 
git history&]
[s0;i93;O0; Button in bottom list of `"found things`" to remove corresponding 
lines&]
[s0;i93;O0; Search for git conflicts&]
[s0;i93;O0; Search for debugging / any logs in the code&]
[s0;i93;O0; In .log file, context goto tries to find corresponding 
LOG/DUMP in the code&]
[s0;i93;O0; .svg files now viewed&]
[s0;i93;O0; Various Icon designer improvements (text Outline option, 
restore alpha, insert symbol into text)&]
[s0;i93;O0; In Win32, About dialog now has info about clang toolchain 
and libclang versions&]
[s0;i93;O0; Main package selection now has list of previously opened 
projects&]
[s0;i93;O0; Insert function parameters list&]
[s0;i93;O0; Insert Symbol&]
[s0;i93;O0; If there are just warnings in the file, theide now displays 
Warnings icon in top`-left (instead Errors)&]
[s0;i93;O0; Improved valgrind support&]
[s0;i93;O0; Navigator now has context menu&]
[s0;i93;O0; `'External mode`' to edit non U`+`+ projects&]
[s0;i93;O0; Improved information about current file (poopup when 
mouse is over cursor position)&]
[s0;i93;O0; Tool to convert virtual methods to `'override`'&]
[s0;i93;O0; ide now shows the count of elements in several new places 
like Navigator or UppHub&]
[s0;i93;O0; primitive markdown export of richtext files (.tpp or 
.qtf)&]
[s0; &]
[s0; [* plugin upgrades:]&]
[s0;* &]
[s0;i150;O0; plugin/jpg to version 10&]
[s0;i150;O0; plugin/tif to version 4.7.1&]
[s0;i150;O0; plugin/png to version 1.6.54&]
[s0; &]
[s0; [* UMK]&]
[s0; &]
[s0;i93;O0; Implement build method recognition in umk.&]
[s0;i93;O0; `-`-hub`-only, `-`-hub`-dir, `-`-out`-dir options&]
[s0; &]
[s0; [* Win32]&]
[s0; &]
[s0;i93;O0; CLANG toolchain updated to 21.1.1&]
[s0;i93;O0; OpenSSL updated to 3.6.0&]
[s5;%% &]
[s5;%% [* Known issue]&]
[s5;%% &]
[s5;i150;O0;%% There might be a problem with Drag and Drop in certain 
versions of KDE in Xwayland mode `- while inconclusive, it looks 
...
the latest Linux distributions with LLVM 20 or newer.&]
[s5;*/%% &]
[s0;%% [* Core]&]
[s0;%% &]
...
int&]
[s0;i150;O0;%% DarkTheme function adjusted to better convert low 
luminosity colors&]
[s0;i150;O0;%% New AColor and SColor types allow simplified adjustments 
for dark mode when runtime theme switch happens.&]
[s0;i150;O0;%% Moveable logic changed to improve incomplete type 
handling&]
...
[s0;i150;O0;%% AllowDarkContent in color selection widgets shows 
colors converted with DarkTheme if dark mode is active&]
[s0;i150;O0;%% Nicer Win11 dialog icons&]
[s0;i150;O0;%% Experimental Wayland support (there is now Wayland 
option in theide setup)&]
[s0;%% &]
[s0;%% [* RichEdit]&]
[s0;%% &]
...
[s0;i150;O0;%% PixelMode `- special mode where images at 100% are 
pixel perfect.&]
...
[s0;i150;O0;%% Search in files new external includes and current 
assembly options&]
